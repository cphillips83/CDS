...
//            var dirCount = 0;
//            var dirsProcessed = 0;
//            var hashAlgorithm = new FileHasher();

//            var directories = new BlockingCollection<DirectoryEntry>();

//            _root = new DirectoryEntry(hashAlgorithm.ComputeDirectoryHash(BasePath), BasePath);
...
//                    {
//                        dirEntries[i] = new DirectoryEntry(hashAlgorithm.ComputeDirectoryHash(dirs[i]), dirs[i]);
